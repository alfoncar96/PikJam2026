...
public class TransicionCueva : MonoBehaviour
{
    [Header("Configuración de la zona")]
    public string Cueva;           // Nombre de la escena a cargar
    public Transform spawnPoint;         // Spawn point en la nueva escena (opcional)

    [Header("Condición")]
    public bool fase2 = true;            // Solo permite cambiar de zona si está activado
